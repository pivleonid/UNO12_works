...
/*=============================================================================================================*/
/*!  \brief конфигурируем интерфейсы и периферию платы
...
void periph_open(void)
{
	...
	/* TODO определяем тип элемента аналогового тракта */
		/* ищем eeprom							*/
		/* если не находим ищем флеш			*/
		/* flash_open() */
	
	/* считываем начальную запись с	типом прибора, версией таблиц, ect		*/
	
	/* считываем таблицы с калибровочной информацией */	
	/* если нет запоминаем таблицы по умолчанию      */
	;
