...
} CPLD_out; //сразу экземпляр структуры
//------------------------------------------------------------//
enum AT_ID 
{
	LNA                    = 1,  //low noise amplifier -> малошумящий усилитель
	LNA_1_GHz_preselector,
	Attenuator_0_65_dB,
	RF_TEST,
	state_preselector_0x05,
	//6  состояние описано далее в функции
...
const  CPLD_out   state_preselector[53][14] = {
	...
	[Attenuator_0_65_dB][3] = { 0, 0, 0, 0b00000011, 0, 0 },
	[Attenuator_0_65_dB][4] = { 0, 0, 0, 0b00000100, 0, 0 },
	[Attenuator_0_65_dB][5] = { 0, 0, 0, 0b00000101, 0, 0 },
	[Attenuator_0_65_dB][6] = { 0, 0, 0, 0b00000110, 0, 0 },
	[Attenuator_0_65_dB][7] = { 0, 0, 0, 0b00000111, 0, 0 },
	[Attenuator_0_65_dB][8] = { 0, 0, 0, 0b00001010, 0, 0 },
	[Attenuator_0_65_dB][9] = { 0, 0, 0, 0b00001011, 0, 0 },
	[Attenuator_0_65_dB][10] = { 0, 0, 0, 0b00001100, 0, 0 },
	[Attenuator_0_65_dB][11] = { 0, 0, 0, 0b00001101, 0, 0 },
	[Attenuator_0_65_dB][12] = { 0, 0, 0, 0b00001110, 0, 0 },
	[Attenuator_0_65_dB][13] = { 0, 0, 0, 0b00001111, 0, 0 },
...
(7)			 1    1    1 - прокидка состояний внутреннего регистра на выход для обоих CPLD
	*/
//data byte - данные одного байта! addr_CPLD -> первая CPLD 1,2,3 вторая -> 4,5,6 
static void set_byte(uint8_t data_byte, uint8_t addr_CPLD)
{
	...
	/*
	Алгоритм работы тернарной условной операции ?: следующий:
	(логическое выражение ? выражение 1 : выражение 2)
    1. Вычисляется логическое выражение.
    2. Если логическое выражение истинно, то вычисляется значение выражения выражение 1, в противном случае (0) — значение выражения выражение 2.
