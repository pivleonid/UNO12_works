...
#define     AD9116_DATACONTROL     (0x02u)
...
#define     AD9116_AUXDAC_I          (0x0Bu)
#define     AD9116_AUXDACI_VAL(a)               (((a) & 0xFF) << 0)
    
#define     AD9116_AUXCTLI           (0x0Cu)
...
#define     AD9116_REFRES            (0x0Du)
    #define     AD9116_REFRES_VAL(a)                (((a) & 0x3F) << 0)
    
#define     AD9116_CALCONTROL        (0x0Eu)
...
#define     AD9116_MEMORY_ADRESS    (0x10u)
    #define     AD9116_MEMORY_ADRESS_VAL(a)         (((a) & 0x3F) << 0)

#define     AD9116_MEMORY_DATA      (0x11u)
    #define     AD9116_MEMORY_DATA_VAL(a)           (((a) & 0x3F) << 0)

#define     AD9116_MEMORY_RW       (0x12u)
